...
import 'package:nuniyoekyc/DummyScreens/dummy_esign_screen.dart';
import 'package:nuniyoekyc/DummyScreens/dummy_personal_details_screen.dart';
...
class DummyWebCamScreen extends StatefulWidget {
  const DummyWebCamScreen({Key? key}) : super(key: key);

  @override
  _DummyWebCamScreenState createState() => _DummyWebCamScreenState();
}

class _DummyWebCamScreenState extends State<DummyWebCamScreen> with WidgetsBindingObserver, TickerProviderStateMixin {
              ...
              children: [
                  ...
                  child: FlatButton(
                    ...
                    onPressed:enableProceedBtnRecordingDone&&enableProceedBtnOTPMatched?() async {
                      ...
                      Navigator.pushReplacement(
                          context, MaterialPageRoute(builder: (BuildContext context) => DummyEsignScreen()));
                    }:null,
                    color: primaryColorOfApp,
                ...
                Align(
                  ...
                  child:Text.rich(
                    TextSpan(
                      children: [
                        TextSpan(text:"Share",recognizer: TapGestureRecognizer()
                      ..onTap = ()  => null,
                        ...
                        TextSpan(text:" The Verification Link To Your Mobile Number If Camera is not Working!",
