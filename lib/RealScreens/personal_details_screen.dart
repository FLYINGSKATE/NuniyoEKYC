...
class _PersonalDetailsScreenState extends State<PersonalDetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) => prefillTexts());
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Visibility(visible: showDeclarationError,child:Text("*Please Check the above checkbox (Mandatory)",textAlign:TextAlign.left,style: GoogleFonts.openSans(textStyle: TextStyle(fontSize: 12,color:Colors.red, letterSpacing: .5),),),),
                SizedBox(height: 20,),
                Container(
