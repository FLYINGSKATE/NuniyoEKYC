...
public class DigioActivity extends AppCompatActivity implements com.digio.in.esign2sdk.DigioResponseListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            esignToken = getIntent().getStringExtra("esignToken");
    ...
    public void InvokeDigioEsign(){
        ...
        try {
            ...
            digio.esign(documentId, phoneNumber,this,esignToken,aditionalParams);// this refers DigioResponseListener
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
