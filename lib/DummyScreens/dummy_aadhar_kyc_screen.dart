...
class DummyAadharKYCScreen extends StatefulWidget {
  const DummyAadharKYCScreen({Key? key}) : super(key: key);

  @override
  _DummyAadharKYCScreenState createState() => _DummyAadharKYCScreenState();
}

class _DummyAadharKYCScreenState extends State<DummyAadharKYCScreen> {
