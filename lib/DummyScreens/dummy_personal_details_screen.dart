...
import 'package:nuniyoekyc/DummyScreens/dummy_options_screen_two.dart';
...
class DummyPersonalDetailsScreen extends StatefulWidget {
  const DummyPersonalDetailsScreen({Key? key}) : super(key: key);

  @override
  _DummyPersonalDetailsScreenState createState() => _DummyPersonalDetailsScreenState();
}

class _DummyPersonalDetailsScreenState extends State<DummyPersonalDetailsScreen> {
                  ...
                  child: InputDecorator(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: <String>['BELOW 1 LAC','1-5 LAC','5-10 LAC','10-25 LAC','GREATER THAN 25 LAC']
                            .map<DropdownMenuItem<String>>((String value) {
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value),
                  ...
                  child: FlatButton(
                    ...
                    onPressed: (declaration&&nationality)&&(motherNameTextEditingController.text!=""&&fatherNameTextEditingController.text!="")&&!proceedBtnPressedOnce&&(motherNameTextEditingController.text.length>=2&&fatherNameTextEditingController.text.length>=2)?() async {
                      ...
                      Navigator.pushReplacement(
                          context, MaterialPageRoute(builder: (BuildContext context) => DummyOptionsScreenTwo()));
                    }:(){
  ...
  void prefillTexts() {
    fatherNameTextEditingController.text = "Dummy Father Name";
    motherNameTextEditingController.text = "Dummy Mother Name";
    this.gender = "FEMALE";
    setState(() {});
  }
