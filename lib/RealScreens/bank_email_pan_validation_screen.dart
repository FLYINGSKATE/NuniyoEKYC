...
class _BankPanEmailValidationScreenState
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) => prefill());
  }
  ...
  Future<void> prefill() async {
    ...
    if(EMAIL_ID.isNotEmpty&&EMAIL_ID!=""){
      if(EMAIL_ID.length>=20){
        EMAIL_ID.substring(0, 20)+"...";
      }

      _emailTextEditingController.text = EMAIL_ID;
      //All the Process To Validate Email Here
      isEmailValidatedSuccessfully=true;
      isValidInputForEmail=true;
    }

    if((DOB.isNotEmpty&&DOB!="")&&(PAN_NO.isNotEmpty&&PAN_NO!="")){
      _panTextEditingController.text = PAN_NO;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Flexible(
                      ...
                      autofillHints: isEmailValidatedSuccessfully?null:[AutofillHints.email],
                      ...
                      onSubmitted: (value){
                            if(value.length>=20){
                              _emailTextEditingController.text = value.substring(0, 20)+"...";
                            }
                      ...
                      onChanged: (_emailID) async {
                        ...
                        if (!EmailValidator.validate(_emailID)) {
                          ...
                          if(isEmailValidatedSuccessfully){
                            ...
                            _emailTextEditingController.text = _emailTextEditingController.text.substring(0, 20)+"....";
                          }
                          if (isEmailValidatedSuccessfully) {
                    ...
                    Container(
                      ...
                      child: FlatButton(
                        ...
                        onPressed: !enableProceedBtn?null:() async {
                          SharedPreferences prefs = await SharedPreferences.getInstance();
