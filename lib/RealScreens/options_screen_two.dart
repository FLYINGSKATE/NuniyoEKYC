...
class _OptionsScreenTwoState extends State<OptionsScreenTwo> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  height: _groupValue=="platinum"?230:110,
                  decoration: BoxDecoration(
                      border: Border.all(
                        color: primaryColorOfApp,
                      ),
                            ...
                            Expanded(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("Platinum",textAlign:TextAlign.left, style:GoogleFonts.openSans(textStyle: TextStyle(color: Colors.black,fontSize: 22.0,letterSpacing: .5,fontWeight: FontWeight.bold)),),
                                    Text("(Recommended)",textAlign:TextAlign.left, style:GoogleFonts.openSans(textStyle: TextStyle(color: Colors.black,fontSize: 12.0,letterSpacing: .5,fontWeight: FontWeight.bold)),),
                                  ],
                                )
                              ),
                            ),
  ...
  void openCheckout(String? orderID) async {
    ...
    var options = {
      ...
      'amount': "100",
      //"order_id":"$orderID",
      'name': 'Mangal Keshav LLP',
      'description': 'Stock Trading',
      "image": "https://www.mangalkeshav.com/assets/images/logo.svg",
  ...
  Future<void> PostPayment(String paymentID,String signature,String merchantID) async {
    ...
    await ApiRepository().RazorPaymentStatus("$amount", merchantID, paymentID,signature ,depositoryCharge);
