...
import '../globals.dart';
import 'dummy_webcam_screen.dart';
...
/////Bank
class DummyBankPanEmailValidationScreen extends StatefulWidget {
  const DummyBankPanEmailValidationScreen({Key? key}) : super(key: key);

  @override
  _DummyBankPanEmailValidationScreenState createState() =>
      _DummyBankPanEmailValidationScreenState();
}

class _DummyBankPanEmailValidationScreenState
    extends State<DummyBankPanEmailValidationScreen> {
                      ...
                      onChanged: (value) {
                        if(value.length>=11){
                          ...
                          Navigator.pushReplacement(
                              context, MaterialPageRoute(builder: (BuildContext context) => DummyPersonalDetailsScreen()));
                        }
                        },
                      inputFormatters: [
                        FilteringTextInputFormatter.allow(RegExp("[0-9A-Z]")),
