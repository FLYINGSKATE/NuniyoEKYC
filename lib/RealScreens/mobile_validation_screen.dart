...
import 'package:nuniyoekyc/DummyScreens/dummy_bank_email_pan_validation_screen.dart';
import 'package:nuniyoekyc/widgets/widgets.dart';
import 'package:otp_autofill/otp_autofill.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../globals.dart';
import '../DummyScreens/dummy_congrats_screen.dart';
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: !isValidOTP ? null : () async{
                      ///Dummy
                      if(phoneNumberString=="90009000." && _otpTextEditingController.text=="12345"){
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => DummyBankPanEmailValidationScreen()),
                        );
                        return;
                      }
                      ///Dummy
